...
suite('startServer', () => {
    ...
    suite('h2', () => {
        ...
        test('rejects unsupported Node version (< 5) only', () => __awaiter(this, void 0, void 0, function* () {
            if (_nodeVersion < 5) {
                return assert.throws(() => __awaiter(this, void 0, void 0, function* () { return yield start_server_2.startServer(_serverOptions); }));
            }
            else {
                return assert.deepEqual(yield _startStubServer(_serverOptions), _stubServer);
            }
        }));
